...
function finish() {
  ...
  /* `welcome`, `auth` et `boot` sont des vues de passage : une lecture réussie ramène toujours au tableau de bord */
  if (!S.view || S.view === 'boot' || S.view === 'welcome' || S.view === 'auth') S.view = 'home';
